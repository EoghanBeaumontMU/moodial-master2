...
Future<MoodValues> getMoodValues(String username) async {
  DateTime pastMonth = DateTime.now().subtract(Duration(days: backs.counter));
  ...
  int monthcount=int.parse(month1)+backs.counter;
  if(monthcount==13)
    {
      monthcount=01;
      backs.yearcounter++;
  ...
  int yearcount= int.parse(year1)+backs.yearcounter;
...
class ChartsBackScreen extends StatefulWidget {
  final User user;
  ...
  @override
  _ChartsBackScreenState createState() => _ChartsBackScreenState(
    user: this.user,
...
class _ChartsBackScreenState extends State<ChartsBackScreen> {
  ...
  print(backs.username);
    happy=getMoodValues(backs.username);
              ...
              child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    Container(alignment: Alignment.bottomLeft, child:Padding(
                        ...
                        onPressed: () {
                          backs.counter=backs.counter+30;
