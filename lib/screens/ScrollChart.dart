...
class ScrollChartScreen extends StatefulWidget {
  final User user;
  ...
  @override
  _ScrollChartScreenState createState() => _ScrollChartScreenState(
    user: this.user,
    navPosCallback: this.navPosCallback,
  );
}

class _ScrollChartScreenState extends State<ScrollChartScreen> {
              ...
              child: Column(
                  ...
                  padding: EdgeInsets.all(15),
                    ...
                    Positioned(top: 60.0, left: 145,
                      child: Text("Mood", textAlign: TextAlign.left,
